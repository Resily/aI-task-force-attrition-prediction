"""
人事から共有されたインサイトデータを予測用データに加工、予測を同時に行う。
"""
...
if __name__ == "__main__":
    ...
    excel_files = [
        base_dir / "data" / "raw" / "predict" / "個人情報削除_0526-0601処理分_結果一覧表_株式会社アドバンテッジリスクマネジメント_70023-20250602-083130159.xlsx"
    ]
    ...
    # 結果格納ディレクトリの確保
    result_dir = base_dir / "model" / "randomForest" / "result"
